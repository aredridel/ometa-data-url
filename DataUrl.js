...
DataUrl.prototype["b64data"] = function $b64data() {var d;return (this._seq(/^([A–Za–z0–9+-]*)/) && ((d = this._getIntermediate()), true) && this._exec((new Buffer(d,"base64")).toString()+"work in progress"))};
